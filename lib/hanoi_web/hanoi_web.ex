defmodule HanoiWeb do
  ...
  defp html_helpers do
    quote do
      ...
      import HanoiWeb.CoreComponents
      import HanoiWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: HanoiWeb.Endpoint,
        router: HanoiWeb.Router,
        statics: HanoiWeb.static_paths()
    end
  end
